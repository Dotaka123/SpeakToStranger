...
const userSchema = new mongoose.Schema({
    ...
    notifyWhenAvailable: { type: Boolean, default: false }, // 🔔 Notif quand quelqu'un arrive dans la queue
    spamWarnings: { type: Number, default: 0 }             // 🛡️ Compteur d'avertissements anti-spam
});
// Schéma Conversation
const chatSchema = new mongoose.Schema({
    ...
    endReason: { type: String, enum: ['normal', 'report', 'reported', 'timeout', 'inactivity', 'mutual', 'error', 'spam', 'user_request'] }
});
